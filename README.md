...
- [ ] Add an email address to the `ADMINS` settings variable in `gamerzilla/gamerzilla/settings/base.py`
- [ ] Change the `SERVER_EMAIL` to the email address used to send e-mails in `gamerzilla/gamerzilla/settings/production.py`
...
- Create a copy of ``gamerzilla/settings/local.py.example``:  
  `cp gamerzilla/settings/local.py.example gamerzilla/settings/local.py` (remembering you should replace `gamerzilla` with your project's name!).
